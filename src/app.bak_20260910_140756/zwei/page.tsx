        ...
        {result && (
          <div className="mt-12 space-y-6">
            ...
            <div className="glass rounded-2xl p-6 border border-gold/40">
              ...
              <p className="text-xs text-gray-500 text-center mb-4">逐宫解读 · 三方四正 · 格局详批 · 四化入宫 · 大限流年</p>
              {(() => {
                try {
                  ...
                  return (
                    <div className="space-y-5">
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          {Object.values(deep.星曜解读).map((s, i) => (
                            <div key={i} className="bg-dark-700 rounded-xl p-3 text-sm text-gray-300 leading-relaxed border border-gold/10">{s}</div>
                          ))}
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          {deep.三方四正.map((s, i) => (
                            <div key={i} className="bg-dark-700 rounded-xl p-3 text-sm text-gray-300 leading-relaxed border border-gold/10"><span className="text-gold font-bold">{s.t型}：</span>{s.解读}</div>
                          ))}
                        </div>
                      </div>
                      ...
                      {deep.格局详批.length > 0 && (
                        <div>
                          ...
                          <div className="space-y-2">
                            {deep.格局详批.map((s, i) => (
                              <div key={i} className="bg-dark-700 rounded-xl p-3 text-sm text-gray-300 leading-relaxed border border-gold/30">{s}</div>
                            ))}
                          </div>
                        </div>
                      )}
                  ...
                  return <p className="text-xs text-gray-500">细批生成失败，请查看下方完整排盘。</p>;
                }
              })()}
            </div>
