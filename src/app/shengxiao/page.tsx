    ...
    <div className="min-h-screen bg-dark-900 text-white">
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-200 mt-2">流年运势 · 生肖配对 · 命盘结合，以生肖为钩，入八字玄机之门</p>
        </div>
        ...
        {tab === "liunian" && (
          <div className="space-y-6">
            <div className="glass rounded-2xl p-5">
              ...
              <div className="mt-4">
                <label className="block text-xs text-gray-200 mb-1">查看年份</label>
              ...
              <div className="glass rounded-2xl p-5 border-gold/30">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-200">五行 · {profile.wuxing}{profile.benmingnian ? " ｜ 适值本命年" : ""}</div>
                  </div>
                </div>
                <p className="mt-3 text-gray-100 text-sm leading-relaxed">{profile.personality}</p>
              </div>
            )}
          ...
          <div className="space-y-6">
            <div className="glass rounded-2xl p-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs text-gray-200 mb-1">甲属相</label>
                ...
                <div>
                  <label className="block text-xs text-gray-200 mb-1">乙属相</label>
            ...
            {pair && (
              <div className="space-y-5">
                <div className="glass rounded-2xl p-6 border-gold/30 text-center">
                  ...
                  <p className="mt-3 text-gray-100">{pair.detail}</p>
                </div>
                ...
                <p className="text-xs text-gray-300 text-center">※ 生肖配对为民俗参考，缘分终靠两人用心经营。</p>
              </div>
            )}
          </div>
        )}
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button type="button" onClick={() => setBirth1({ ...birth1, gender: 1 })}
                    className={`px-3 py-2 rounded-lg text-center text-sm font-semibold border transition ${
                      birth1.gender === 1 ? "bg-gold text-dark-900 border-gold" : "bg-dark-700 border-gold/20 text-gray-200"
                    }`}>男</button>
                  <button type="button" onClick={() => setBirth1({ ...birth1, gender: 2 })}
                    className={`px-3 py-2 rounded-lg text-center text-sm font-semibold border transition ${
                      birth1.gender === 2 ? "bg-gold text-dark-900 border-gold" : "bg-dark-700 border-gold/20 text-gray-200"
                    }`}>女</button>
                </div>
              </div>
            ...
            {bazi && (
              <div className="space-y-5">
                <div className="glass rounded-2xl p-5 border-gold/30 text-center">
                  ...
                  <div className="text-sm text-gray-200">五行 {bazi.wuxing} · 本命年 {bazi.benmingYear}</div>
                ...
                <div className="glass rounded-2xl p-5 border-emerald-500/30">
                  ...
                  <p className="text-sm text-gray-100 leading-relaxed">{bazi.notes}</p>
                </div>
                <p className="text-xs text-gray-300 text-center">※ 生肖与八字结合为传统文化视角解读，非科学预测，供参详娱乐。</p>
              </div>
            )}
          </div>
        )}
