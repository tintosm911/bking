...
const statusStyles: Record<string, string> = {
  ...
  expired: "bg-gray-500/10 text-gray-200 border-gray-500/10",
};
    ...
    >
      ...
      <div className="flex items-center justify-between px-5 pt-4 pb-2">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-white/80">{categoryNames[wish.category] || "其他"}</span>
        </div>
      ...
      <div className="px-5 pb-4">
        ...
        <p className={`text-xs text-white/80 leading-relaxed transition-all ${
